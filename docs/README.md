...
| План | Статус |
|---|---|
| [plans/2026-08-24-backlog.md](plans/2026-08-24-backlog.md) | набор независимых пунктов (третий по счёту, после `2026-08-18` и `2026-08-19`): имя процесса бэкенда, MCP/API/CLI и внешний доступ вместо исходников, систематизация через Studio, документация экосистемы, система индексов, harness, повторы компонентов UI, dev-заголовок клиента |
| [plans/2026-08-24-knowledge-management.md](plans/2026-08-24-knowledge-management.md) | управление знаниями: цена вызова в токенах и разделы статей сделаны; модуль счёта, атрибуция вызовов по реестру, проверка целостности, стык со Studio — впереди |
...
| [plans/2026-08-29-crate-split-analysis.md](plans/2026-08-29-crate-split-analysis.md) | разделение на крейты: замер срезов и обратных рёбер, девять хабов-перечислений, четыре варианта (рантайм-выключатели / features / 3→8 крейтов / полная нарезка). Решения нет |
...
`TAURI_CLIENT_PLAN.md` там. Для MPI клиент это обычный браузер (см. `CONTRACTS.md` в каноне экосистемы).

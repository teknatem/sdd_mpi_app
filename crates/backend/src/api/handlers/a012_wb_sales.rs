...
/// Р В РЎвЂєР В РўвЂР В Р вЂ¦Р В Р’В° строка Р РЋР вЂљР В Р’В°Р РЋР С“Р РЋРІвЂљВ¬Р В РЎвЂР РЋРІР‚С›Р РЋР вЂљР В РЎвЂўР В Р вЂ Р В РЎвЂќР В РЎвЂ Р РЋР вЂљР В Р’ВµР В РЎвЂќР В Р’В»Р В Р’В°Р В РЎВР В Р вЂ¦Р В РЎвЂўР В РІвЂћвЂ“ Р В Р’В°Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂР В Р’В±Р РЋРЎвЂњР РЋРІР‚В Р В РЎвЂР В РЎвЂ по a012-Р В РўвЂР В РЎвЂўР В РЎвЂќР РЋРЎвЂњР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р РЋРЎвЂњ.
///
/// Р В Р Р‹Р В РЎвЂўР В РЎвЂўР РЋРІР‚С™Р В Р вЂ Р В Р’ВµР РЋРІР‚С™Р РЋР С“Р РЋРІР‚С™Р В Р вЂ Р РЋРЎвЂњР В Р’ВµР РЋРІР‚С™ Р В РЎвЂўР В РўвЂР В Р вЂ¦Р В РЎвЂўР В РІвЂћвЂ“ reserve-Р В Р’В·Р В Р’В°Р В РЎвЂ”Р В РЎвЂР РЋР С“Р В РЎвЂ `p913_wb_advert_order_attr` (от a026)
/// с Р РЋРІР‚С™Р В Р’ВµР В РЎВ же `order_key`, что Р В РЎвЂ srid этого Р В РўвЂР В РЎвЂўР В РЎвЂќР РЋРЎвЂњР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р В Р’В° a012.
#[derive(Debug, Clone, Serialize)]
pub struct AdvertAttributionRowDto {
    ...
    /// `wb_advert_campaign_code` (advert_id как строка).
    ...
    pub nomenclature_article: Option<String>,
    /// Р В Р Р‹Р РЋРЎвЂњР В РЎВР В РЎВР В Р’В° по строке.
    pub amount: f64,
    /// Доля Р РЋР С“Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂўР В РЎвЂќР В РЎвЂ в общей Р РЋР С“Р РЋРЎвЂњР В РЎВР В РЎВР В Р’Вµ (в процентах).
    pub ratio_percent: f64,
    /// Р В РЎСџР РЋР вЂљР В РЎвЂР В Р’В·Р В Р вЂ¦Р В Р’В°Р В РЎвЂќ Р вЂ™Р’В«Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р’В±Р В Р’В»Р В Р’ВµР В РЎВР В Р вЂ¦Р В Р’В°Р РЋР РЏР вЂ™Р’В» Р Р†Р вЂљРІР‚Сњ Р В Р’В°Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂР В Р’В±Р РЋРЎвЂњР РЋРІР‚В Р В РЎвЂР РЋР РЏ была без явного связанного заказа.
    pub is_problem: bool,
    /// UUID Р В РўвЂР В РЎвЂўР В РЎвЂќР РЋРЎвЂњР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р В Р’В° a026, Р В РЎвЂР В Р’В· которого Р В РЎвЂ”Р РЋР вЂљР В РЎвЂР РЋРІвЂљВ¬Р В Р’В»Р В Р’В° reserve-строка.
...
/// Р В Р Р‹Р В Р вЂ Р В РЎвЂўР В РўвЂР В Р вЂ¦Р РЋРІР‚в„–Р В Р’Вµ Р В РЎвЂР РЋРІР‚С™Р В РЎвЂўР В РЎвЂ“Р В РЎвЂ по Р РЋР С“Р РЋРІР‚С™Р РЋР вЂљР В Р’В°Р В Р вЂ¦Р В РЎвЂР РЋРІР‚В Р В Р’Вµ Р В Р’В°Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂР В Р’В±Р РЋРЎвЂњР РЋРІР‚В Р В РЎвЂР В РЎвЂ.
#[derive(Debug, Clone, Serialize)]
pub struct AdvertAttributionTotals {
    /// Кол-во reserve-строк.
    pub rows_count: usize,
    /// Кол-во Р РЋРЎвЂњР В Р вЂ¦Р В РЎвЂР В РЎвЂќР В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р РЋРІР‚в„–Р РЋРІР‚В¦ Р В РЎвЂќР В Р’В°Р В РЎВР В РЎвЂ”Р В Р’В°Р В Р вЂ¦Р В РЎвЂР В РІвЂћвЂ“.
    pub campaigns_count: usize,
    /// Р С›Р в‚¬ всех reserve-строк (= Р В РЎвЂўР В Р’В¶Р В РЎвЂР В РўвЂР В Р’В°Р В Р’ВµР В РЎВР В Р’В°Р РЋР РЏ Р РЋР С“Р РЋРЎвЂњР В РЎВР В РЎВР В Р’В° advert_clicks_order_expense).
    pub sum: f64,
    ...
    /// `true`, Р В Р’ВµР РЋР С“Р В Р’В»Р В РЎвЂ |sum в€’ gl_advert_expense| < 0.01.
    pub is_match: Option<bool>,
}

/// Ответ Р РЋР РЉР В Р вЂ¦Р В РўвЂР В РЎвЂ”Р В РЎвЂўР В РЎвЂР В Р вЂ¦Р РЋРІР‚С™Р В Р’В° `GET /api/a012/wb-sales/:id/advert-attribution`.
#[derive(Debug, Clone, Serialize)]
...
/// Handler Р В РўвЂР В Р’В»Р РЋР РЏ Р РЋР вЂљР В Р’В°Р РЋР С“Р РЋРІвЂљВ¬Р В РЎвЂР РЋРІР‚С›Р РЋР вЂљР В РЎвЂўР В Р вЂ Р В РЎвЂќР В РЎвЂ Р РЋР вЂљР В Р’ВµР В РЎвЂќР В Р’В»Р В Р’В°Р В РЎВР В Р вЂ¦Р В РЎвЂўР В РІвЂћвЂ“ Р В Р’В°Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂР В Р’В±Р РЋРЎвЂњР РЋРІР‚В Р В РЎвЂР В РЎвЂ по Р В РўвЂР В РЎвЂўР В РЎвЂќР РЋРЎвЂњР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р РЋРЎвЂњ a012.
///
/// Возвращает все reserve-Р РЋР С“Р РЋРІР‚С™Р РЋР вЂљР В РЎвЂўР В РЎвЂќР В РЎвЂ `p913_wb_advert_order_attr` с
/// `order_key=srid(document_no)`, Р В РЎвЂўР В Р’В±Р В РЎвЂўР В РЎвЂ“Р В Р’В°Р РЋРІР‚В°Р РЋРІР‚ВР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В Р’Вµ Р В РЎвЂР В Р вЂ¦Р РЋРІР‚С›Р В РЎвЂўР РЋР вЂљР В РЎВР В Р’В°Р РЋРІР‚В Р В РЎвЂР В Р’ВµР В РІвЂћвЂ“ об Р В РЎвЂР РЋР С“Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂР В Р вЂ¦Р В РЎвЂўР В РЎВ a026,
/// плюс Р РЋР С“Р РЋР вЂљР В Р’В°Р В Р вЂ Р В Р вЂ¦Р В Р’ВµР В Р вЂ¦Р В РЎвЂР В Р’Вµ Р С›Р в‚¬(amount) с Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р вЂ Р В РЎвЂўР В РўвЂР В РЎвЂќР В РЎвЂўР В РІвЂћвЂ“ `advert_clicks_order_expense` в журнале.

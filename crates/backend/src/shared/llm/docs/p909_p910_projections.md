...
## Классификатор оборотов {#turnover-classifier}
...
## Правила соответствия данных маркетплейсов {#mapping-rules}
...
## P909 — регистр оборотов по строкам заказов {#p909}
...
## P910 — регистр отвязанных оборотов {#p910}
...
## Выбор актуального значения {#value-selection}
...
## Роль p903_wb_finance_report {#p903-role}

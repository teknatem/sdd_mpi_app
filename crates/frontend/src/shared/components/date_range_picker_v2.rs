//! DateRangePickerV2 — экспериментальный выбор периода (поколение 2).
//!
//! Развитие `date_range_picker_exp` с упором на три вещи:
...
//! 2. **Интервалы.** В попапе — пресеты («3 мес», «13 нед», «С начала года») и выбор
//!    диапазона двумя кликами с подсветкой при наведении.
//! 3. **Никаких нативных `input[type=date]`** — значит, нет чёрной иконки календаря
...
/// DateRangePickerV2 — выбор периода: 4 режима, свободный ввод текстом, интервалы.
#[component]
pub fn DateRangePickerV2(
    ...
    view! {
        <Flex vertical=true gap=FlexGap::Size(4)>
            ...
            <div class="date-range-picker date-range-picker--v2">
